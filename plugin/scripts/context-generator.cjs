"use strict";var Ft=Object.create;var H=Object.defineProperty;var $t=Object.getOwnPropertyDescriptor;var Ht=Object.getOwnPropertyNames;var Gt=Object.getPrototypeOf,Xt=Object.prototype.hasOwnProperty;var jt=(r,e)=>{for(var t in e)H(r,t,{get:e[t],enumerable:!0})},fe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ht(e))!Xt.call(r,n)&&n!==t&&H(r,n,{get:()=>e[n],enumerable:!(s=$t(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?Ft(Gt(r)):{},fe(e||!r||!r.__esModule?H(t,"default",{value:r,enumerable:!0}):t,r)),Bt=r=>fe(H({},"__esModule",{value:!0}),r);var As={};jt(As,{generateContext:()=>Pt,generateContextWithStats:()=>ge});module.exports=Bt(As);var xt=y(require("path"),1),wt=require("os"),kt=require("fs");var de=require("bun:sqlite");var l=require("path"),re=require("os"),M=require("fs");var be=require("url");var N=require("fs"),Se=require("path");var Wt=null;function Vt(r){return(Wt??process.stderr.write.bind(process.stderr))(r)}function Z(r){Vt(r)}var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),ee=null,se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=U.logsDir();(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Se.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=U.settings();if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let g="";if(n){let{sessionId:p,memorySessionId:O,correlationId:S,...E}=n;Object.keys(E).length>0&&(g=` {${Object.entries(E).map(([R,f])=>`${R}=${f}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${c}${s}${g}${m}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",g={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,g,n),o}},u=new se;var ss={};function Yt(){return typeof __dirname<"u"?__dirname:(0,l.dirname)((0,be.fileURLToPath)(ss.url))}var Kt=Yt();function qt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,l.join)((0,re.homedir)(),".claude-mem"),e=(0,l.join)(r,"settings.json");try{if((0,M.existsSync)(e)){let t=JSON.parse((0,M.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var b=qt(),D=process.env.CLAUDE_CONFIG_DIR||(0,l.join)((0,re.homedir)(),".claude"),ys=(0,l.join)(D,"plugins","marketplaces","thedotmack"),Jt=(0,l.join)(b,"archives"),Qt=(0,l.join)(b,"logs"),zt=(0,l.join)(b,"trash"),Zt=(0,l.join)(b,"backups"),es=(0,l.join)(b,"modes"),Us=(0,l.join)(b,"settings.json"),Re=(0,l.join)(b,"claude-mem.db"),ts=(0,l.join)(b,"vector-db"),Oe=(0,l.join)(b,"observer-sessions"),ne=(0,l.basename)(Oe),xs=(0,l.join)(D,"settings.json"),ws=(0,l.join)(D,"commands"),ks=(0,l.join)(D,"CLAUDE.md");function he(r){(0,M.mkdirSync)(r,{recursive:!0})}function Ae(){return(0,l.join)(Kt,"..")}var U={dataDir:()=>b,workerPid:()=>(0,l.join)(b,"worker.pid"),serverBetaPid:()=>(0,l.join)(b,".server-beta.pid"),serverBetaPort:()=>(0,l.join)(b,".server-beta.port"),serverBetaRuntime:()=>(0,l.join)(b,".server-beta.runtime.json"),settings:()=>(0,l.join)(b,"settings.json"),database:()=>(0,l.join)(b,"claude-mem.db"),chroma:()=>(0,l.join)(b,"chroma"),combinedCerts:()=>(0,l.join)(b,"combined_certs.pem"),transcriptsConfig:()=>(0,l.join)(b,"transcript-watch.json"),transcriptsState:()=>(0,l.join)(b,"transcript-watch-state.json"),corpora:()=>(0,l.join)(b,"corpora"),supervisorRegistry:()=>(0,l.join)(b,"supervisor.json"),envFile:()=>(0,l.join)(b,".env"),logsDir:()=>Qt,archives:()=>Jt,trash:()=>zt,backups:()=>Zt,modes:()=>es,vectorDb:()=>ts,observerSessions:()=>Oe};var Ce=require("crypto");function oe(r,e,t){return(0,Ce.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ie(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude",L="unknown";function rs(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function v(r){if(!r)return A;let e=rs(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function Ie(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ne(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(e,t,n)??void 0}var De=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Le=new RegExp(`<(${De.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),ve=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Me=100;function ns(r){let e=Object.fromEntries(De.map(n=>[n,0]));Le.lastIndex=0;let t=0,s=r.replace(Le,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Me&&u.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Me,contentLength:r.length}),{stripped:s.trim(),counts:e}}function ye(r){return ns(r).stripped}var os=["task-notification"],Bs=new RegExp(`^\\s*<(${os.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Ws=256*1024;var ae=4e3;function G(r){let e=r.trim(),s=ye(r).trim()||e;return s.length<=ae?s:(u.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:ae}),`${s.slice(0,ae-1)}\u2026`)}function is(r,e){return{customTitle:r,platformSource:e?v(e):void 0}}var X=class{db;constructor(e=Re){e instanceof de.Database?this.db=e:(e!==":memory:"&&he(b),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),u.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){u.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),u.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),u.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="relevance",m=c?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,g=n?`LIMIT ${n}`:"",T=e.map(()=>"?").join(","),p=[...e],O=[];if(o&&(O.push("project = ?"),p.push(o)),i)if(Array.isArray(i)){let f=i.map(()=>"?").join(",");O.push(`type IN (${f})`),p.push(...i)}else O.push("type = ?"),p.push(i);if(a){let f=Array.isArray(a)?a:[a],z=f.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");p.push(...f),O.push(`(${z.join(" OR ")})`)}if(d){let f=Array.isArray(d)?d:[d],z=f.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");f.forEach(Te=>{p.push(`%${Te}%`,`%${Te}%`)}),O.push(`(${z.join(" OR ")})`)}let S=O.length>0?`WHERE id IN (${T}) AND ${O.join(" AND ")}`:`WHERE id IN (${T})`,h=this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
      ${m}
      ${g}
    `).all(...p);if(!c)return h;let R=new Map(h.map(f=>[f.id,f]));return e.map(f=>R.get(f)).filter(f=>!!f)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=is(n,o),c=d.platformSource??A,m=G(s),g=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let c=a??Date.now(),m=new Date(c).toISOString();return this.db.transaction(()=>{let T=[],p=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),O=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let E of s){let h=oe(e,E.title,E.narrative),R=p.get(e,t,E.type,E.title,E.subtitle,JSON.stringify(E.facts),E.narrative,JSON.stringify(E.concepts),JSON.stringify(E.files_read),JSON.stringify(E.files_modified),o||null,i,E.agent_type??null,E.agent_id??null,h,m,c,d||null);if(R){T.push(R.id);continue}let f=O.get(e,h);if(!f)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${h}`);T.push(f.id)}let S=null;if(n){let h=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,m,c);S=Number(h.lastInsertRowid)}return{observationIds:T,summaryId:S,createdAtEpoch:c}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),m=[...e],g=o?`WHERE id IN (${c}) AND project = ?`:`WHERE id IN (${c})`;o&&m.push(o);let p=this.db.prepare(`
      SELECT * FROM session_summaries
      ${g}
      ${a}
      ${d}
    `).all(...m);if(!i)return p;let O=new Map(p.map(S=>[S.id,S]));return e.map(S=>O.get(S)).filter(S=>!!S)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),m=[...e],g=o?"AND s.project = ?":"";o&&m.push(o);let p=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...m);if(!i)return p;let O=new Map(p.map(S=>[S.id,S]));return e.map(S=>O.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let E=`
