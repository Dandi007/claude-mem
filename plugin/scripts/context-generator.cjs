"use strict";var Ft=Object.create;var G=Object.defineProperty;var $t=Object.getOwnPropertyDescriptor;var Ht=Object.getOwnPropertyNames;var Gt=Object.getPrototypeOf,Xt=Object.prototype.hasOwnProperty;var jt=(r,e)=>{for(var t in e)G(r,t,{get:e[t],enumerable:!0})},fe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ht(e))!Xt.call(r,n)&&n!==t&&G(r,n,{get:()=>e[n],enumerable:!(s=$t(e,n))||s.enumerable});return r};var U=(r,e,t)=>(t=r!=null?Ft(Gt(r)):{},fe(e||!r||!r.__esModule?G(t,"default",{value:r,enumerable:!0}):t,r)),Bt=r=>fe(G({},"__esModule",{value:!0}),r);var As={};jt(As,{generateContext:()=>Pt,generateContextWithStats:()=>ge});module.exports=Bt(As);var xt=U(require("path"),1),wt=require("os"),kt=require("fs");var de=require("bun:sqlite");var p=require("path"),re=require("os"),D=require("fs");var be=require("url");var N=require("fs"),Se=require("path");var Wt=null;function Vt(r){return(Wt??process.stderr.write.bind(process.stderr))(r)}function Z(r){Vt(r)}var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),ee=null,se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Se.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=te[e].padEnd(5),d=t.padEnd(6),m="";n?.correlationId?m=`[${n.correlationId}] `:n?.sessionId&&(m=`[session-${n.sessionId}] `);let c="";if(o!=null)if(o instanceof Error)c=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{c=`
`+JSON.stringify(o,null,2)}catch{c=" "+this.formatData(o)}else c=" "+this.formatData(o);let l="";if(n){let{sessionId:E,memorySessionId:b,correlationId:h,...g}=n;Object.keys(g).length>0&&(l=` {${Object.entries(g).map(([S,f])=>`${S}=${f}`).join(", ")}}`)}let O=`[${i}] [${a}] [${d}] ${m}${s}${l}${c}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,O+`
`,"utf8")}catch(E){Z(`[LOGGER] Failed to write to log file: ${E instanceof Error?E.message:String(E)}
`)}else Z(O+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){ee=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!ee||!(s instanceof Error))return;ee(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}happyPathError(e,t,s,n,o=""){let m=((new Error().stack||"").split(`
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=m?`${m[1].split("/").pop()}:${m[2]}`:"unknown",l={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},u=new se;var ss={};function Yt(){return typeof __dirname<"u"?__dirname:(0,p.dirname)((0,be.fileURLToPath)(ss.url))}var Kt=Yt();function qt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,p.join)((0,re.homedir)(),".claude-mem"),e=(0,p.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var R=qt(),v=process.env.CLAUDE_CONFIG_DIR||(0,p.join)((0,re.homedir)(),".claude"),ys=(0,p.join)(v,"plugins","marketplaces","thedotmack"),Jt=(0,p.join)(R,"archives"),Qt=(0,p.join)(R,"logs"),zt=(0,p.join)(R,"trash"),Zt=(0,p.join)(R,"backups"),es=(0,p.join)(R,"modes"),Us=(0,p.join)(R,"settings.json"),Re=(0,p.join)(R,"claude-mem.db"),ts=(0,p.join)(R,"vector-db"),Oe=(0,p.join)(R,"observer-sessions"),ne=(0,p.basename)(Oe),xs=(0,p.join)(v,"settings.json"),ws=(0,p.join)(v,"commands"),ks=(0,p.join)(v,"CLAUDE.md");function he(r){(0,D.mkdirSync)(r,{recursive:!0})}function Ae(){return(0,p.join)(Kt,"..")}var x={dataDir:()=>R,workerPid:()=>(0,p.join)(R,"worker.pid"),serverBetaPid:()=>(0,p.join)(R,".server-beta.pid"),serverBetaPort:()=>(0,p.join)(R,".server-beta.port"),serverBetaRuntime:()=>(0,p.join)(R,".server-beta.runtime.json"),settings:()=>(0,p.join)(R,"settings.json"),database:()=>(0,p.join)(R,"claude-mem.db"),chroma:()=>(0,p.join)(R,"chroma"),combinedCerts:()=>(0,p.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,p.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,p.join)(R,"transcript-watch-state.json"),corpora:()=>(0,p.join)(R,"corpora"),supervisorRegistry:()=>(0,p.join)(R,"supervisor.json"),envFile:()=>(0,p.join)(R,".env"),logsDir:()=>Qt,archives:()=>Jt,trash:()=>zt,backups:()=>Zt,modes:()=>es,vectorDb:()=>ts,observerSessions:()=>Oe};var Ie=require("crypto");function oe(r,e,t){return(0,Ie.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ie(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude",L="unknown";function rs(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return A;let e=rs(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function Ce(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ne(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(e,t,n)??void 0}var De=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Le=new RegExp(`<(${De.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),ve=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Me=100;function ns(r){let e=Object.fromEntries(De.map(n=>[n,0]));Le.lastIndex=0;let t=0,s=r.replace(Le,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Me&&u.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Me,contentLength:r.length}),{stripped:s.trim(),counts:e}}function ye(r){return ns(r).stripped}var os=["task-notification"],Bs=new RegExp(`^\\s*<(${os.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Ws=256*1024;var ae=4e3;function X(r){let e=r.trim(),s=ye(r).trim()||e;return s.length<=ae?s:(u.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:ae}),`${s.slice(0,ae-1)}\u2026`)}function is(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var j=class{db;constructor(e=Re){e instanceof de.Database?this.db=e:(e!==":memory:"&&he(R),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.addSessionDbIdColumn()}addSessionDbIdColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(33),t=this.db.query("PRAGMA table_info(observations)").all(),s=this.db.query("PRAGMA table_info(session_summaries)").all(),n=t.some(i=>i.name==="session_db_id"),o=s.some(i=>i.name==="session_db_id");if(!(e&&n&&o)){try{n||this.db.run("ALTER TABLE observations ADD COLUMN session_db_id INTEGER"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_session_db_id ON observations(session_db_id)"),this.db.run(`
        UPDATE observations
      ...
      `),o||this.db.run("ALTER TABLE session_summaries ADD COLUMN session_db_id INTEGER"),this.db.run("CREATE INDEX IF NOT EXISTS idx_session_summaries_session_db_id ON session_summaries(session_db_id)"),this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_session ON pending_messages(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_status ON pending_messages(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_claude_session ON pending_messages(content_session_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(16,new Date().toISOString()),u.debug("DB","pending_messages table created successfully")}renameSessionIdColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(17))return;u.debug("DB","Checking session ID columns for semantic clarity rename");let t=0,s=(n,o,i)=>{let a=this.db.query(`PRAGMA table_info(${n})`).all(),d=a.some(c=>c.name===o);return a.some(c=>c.name===i)?!1:d?(this.db.run(`ALTER TABLE ${n} RENAME COLUMN ${o} TO ${i}`),u.debug("DB",`Renamed ${n}.${o} to ${i}`),!0):(u.warn("DB",`Column ${o} not found in ${n}, skipping rename`),!1)};s("sdk_sessions","claude_session_id","content_session_id")&&t++,s("sdk_sessions","sdk_session_id","memory_session_id")&&t++,s("pending_messages","claude_session_id","content_session_id")&&t++,s("observations","sdk_session_id","memory_session_id")&&t++,s("session_summaries","sdk_session_id","memory_session_id")&&t++,s("user_prompts","claude_session_id","content_session_id")&&t++,this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(17,new Date().toISOString()),t>0?u.debug("DB",`Successfully renamed ${t} session ID columns`):u.debug("DB","No session ID column renames needed (already up to date)")}repairSessionIdColumnRename(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(19)||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(19,new Date().toISOString())}addFailedAtEpochColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(20))return;this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="failed_at_epoch")||(this.db.run("ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"),u.debug("DB","Added failed_at_epoch column to pending_messages table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(20,new Date().toISOString())}addOnUpdateCascadeToForeignKeys(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(21))return;u.debug("DB","Adding ON UPDATE CASCADE to FK constraints on observations and session_summaries"),this.db.run("PRAGMA foreign_keys = OFF"),this.db.run("BEGIN TRANSACTION"),this.db.run("DROP TRIGGER IF EXISTS observations_ai"),this.db.run("DROP TRIGGER IF EXISTS observations_ad"),this.db.run("DROP TRIGGER IF EXISTS observations_au"),this.db.run("DROP TABLE IF EXISTS observations_new");let t=this.db.query("PRAGMA table_info(observations)").all(),s=t.some(T=>T.name==="metadata"),n=t.some(T=>T.name==="content_hash"),o=s?`,
        ...
        content_hash TEXT`:"",d=n?", content_hash":"",m=`
      CREATE TABLE observations_new (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        memory_session_id TEXT NOT NULL,
        project TEXT NOT NULL,
    ...
    `).all(ne),t=[],s=new Set,n={};for(let i of e){let a=y(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=Ce(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(e)}findRecentDuplicateUserPrompt(e,t,s){return Ne(this.db,e,X(t),s)}getRecentSessionsWithStatus(e,t=3){return this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,m=s==="relevance",c=m?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,l=n?`LIMIT ${n}`:"",O=e.map(()=>"?").join(","),E=[...e],b=[];if(o&&(b.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let f=i.map(()=>"?").join(",");b.push(`type IN (${f})`),E.push(...i)}else b.push("type = ?"),E.push(i);if(a){let f=Array.isArray(a)?a:[a],M=f.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...f),b.push(`(${M.join(" OR ")})`)}if(d){let f=Array.isArray(d)?d:[d],M=f.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");f.forEach(Te=>{E.push(`%${Te}%`,`%${Te}%`)}),b.push(`(${M.join(" OR ")})`)}let h=b.length>0?`WHERE id IN (${O}) AND ${b.join(" AND ")}`:`WHERE id IN (${O})`,T=this.db.prepare(`
      SELECT *
      FROM observations
      ${h}
      ${c}
      ${l}
    `).all(...E);if(!m)return T;let S=new Map(T.map(f=>[f.id,f]));return e.map(f=>S.get(f)).filter(f=>!!f)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=is(n,o),m=d.platformSource??A,c=X(s),l=this.db.prepare(`
    ...
    `).get(e);if(l){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let E=l.platform_source?.trim()?y(l.platform_source):void 0;if(!E)this.db.prepare(`
            UPDATE sdk_sessions SET platform_source = ?
            WHERE content_session_id = ?
              AND COALESCE(platform_source, '') = ''
          `).run(d.platformSource,e);else if(E!==d.platformSource)throw new Error(`Platform source conflict for session ${e}: existing=${E}, received=${d.platformSource}`)}return l.id}return this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,m,c,d.customTitle||null,i.toISOString(),a),this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e).id}saveUserPrompt(e,t,s){let n=new Date,o=n.getTime(),i=X(s);return this.db.prepare(`
    ...
    `).run(e,t,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),m=new Date(d).toISOString(),c=oe(e,s.title,s.narrative),l=this.db.prepare("SELECT id FROM sdk_sessions WHERE memory_session_id = ?").get(e)?.id??null,E=this.db.prepare(`
    ...
    `).get(e,l,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,c,m,d,a||null,s.metadata??null);if(E)return{id:E.id,createdAtEpoch:E.created_at_epoch};let b=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,c);if(!b)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${c}`);return{id:b.id,createdAtEpoch:b.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),m=this.db.prepare("SELECT id FROM sdk_sessions WHERE memory_session_id = ?").get(e)?.id??null,l=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, session_db_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,m,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(l.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let m=a??Date.now(),c=new Date(m).toISOString(),l=this.db.prepare("SELECT id FROM sdk_sessions WHERE memory_session_id = ?").get(e)?.id??null;return this.db.transaction(()=>{let E=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, session_db_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),h=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let T of s){let S=oe(e,T.title,T.narrative),f=b.get(e,l,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),o||null,i,T.agent_type??null,T.agent_id??null,S,c,m,d||null);if(f){E.push(f.id);continue}let M=h.get(e,S);if(!M)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${S}`);E.push(M.id)}let g=null;if(n){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, session_db_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,l,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,c,m);g=Number(S.lastInsertRowid)}return{observationIds:E,summaryId:g,createdAtEpoch:m}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),c=[...e],l=o?`WHERE id IN (${m}) AND project = ?`:`WHERE id IN (${m})`;o&&c.push(o);let E=this.db.prepare(`
      SELECT * FROM session_summaries
      ${l}
      ${a}
      ${d}
    `).all(...c);if(!i)return E;let b=new Map(E.map(h=>[h.id,h]));return e.map(h=>b.get(h)).filter(h=>!!h)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),c=[...e],l=o?"AND s.project = ?":"";o&&c.push(o);let E=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...c);if(!i)return E;let b=new Map(E.map(h=>[h.id,h]));return e.map(h=>b.get(h)).filter(h=>!!h)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,m;if(e!==null){let g=`
      ...
      `,T=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let S=this.db.prepare(g).all(e,...a,s+1),f=this.db.prepare(T).all(e,...a,n+1);if(S.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=S.length>0?S[S.length-1].created_at_epoch:t,m=f.length>0?f[f.length-1].created_at_epoch:t}catch(S){return S instanceof Error?u.error("DB","Error getting boundary observations",{project:o},S):u.error("DB","Error getting boundary observations with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}else{let g=`
      ...
      `,T=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let S=this.db.prepare(g).all(t,...a,s),f=this.db.prepare(T).all(t,...a,n+1);if(S.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=S.length>0?S[S.length-1].created_at_epoch:t,m=f.length>0?f[f.length-1].created_at_epoch:t}catch(S){return S instanceof Error?u.error("DB","Error getting boundary timestamps",{project:o},S):u.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}let c=`
      SELECT *
      FROM observations
    ...
    `).run(e.content_session_id,e.memory_session_id,e.project,y(e.platform_source),e.user_prompt,e.started_at,e.started_at_epoch,e.completed_at,e.completed_at_epoch,e.status).lastInsertRowid}}importSessionSummary(e){let t=this.db.prepare("SELECT id FROM session_summaries WHERE memory_session_id = ?").get(e.memory_session_id);if(t)return{imported:!1,id:t.id};let s=this.db.prepare("SELECT id FROM sdk_sessions WHERE memory_session_id = ?").get(e.memory_session_id)?.id??null;return{imported:!0,id:this.db.prepare(`
      INSERT INTO session_summaries (
        memory_session_id, session_db_id, project, request, investigated, learned,
        completed, next_steps, files_read, files_edited, notes,
        prompt_number, discovery_tokens, created_at, created_at_epoch
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e.memory_session_id,s,e.project,e.request,e.investigated,e.learned,e.completed,e.next_steps,e.files_read,e.files_edited,e.notes,e.prompt_number,e.discovery_tokens||0,e.created_at,e.created_at_epoch).lastInsertRowid}}importObservation(e){let t=this.db.prepare(`
      SELECT id FROM observations
      WHERE memory_session_id = ? AND title = ? AND created_at_epoch = ?
    `).get(e.memory_session_id,e.title,e.created_at_epoch);if(t)return{imported:!1,id:t.id};let s=this.db.prepare("SELECT id FROM sdk_sessions WHERE memory_session_id = ?").get(e.memory_session_id)?.id??null;return{imported:!0,id:this.db.prepare(`
      INSERT INTO observations (
  ...
  `).all(e,e,...s,...o,t.totalObservationCount)}function We(r,e,t){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+me)}function Ve(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, '${L}') as platform_source,
...
`}function At(r,e,t,s){let n=[];return s?n.push(...mt(r)):n.push(...Ze(r)),s?n.push(...ct()):n.push(...et()),s&&(n.push(...Et()),n.push(...lt())),K(t)&&(s?n.push(...pt(e,t)):n.push(...tt(e,t))),n}var Ee=U(require("path"),1);function z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function le(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function pe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Ct(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function It(r,e){return Ee.default.isAbsolute(r)?Ee.default.relative(e,r):r}function Nt(r,e,t){let s=z(r);if(s.length>0)return It(s[0],e);if(t){let n=z(t);if(n.length>0)return It(n[0],e)}return"General"}function ls(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Ct(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?z(r.facts).join(`
`):null}function ps(r,e,t,s){let n=[];n.push(...st(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=le(a.displayTime);n.push(...it(a,d))}else{let a=i.data,d=pe(a.created_at),c=d!==o?d:"";if(o=d,t.has(a.id)){let O=Lt(a,s);n.push(...ot(a,c,O,s))}else n.push(nt(a,c,s))}return n}function gs(r,e,t,s,n){let o=[];o.push(...gt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,c=le(m.displayTime);o.push(...bt(m,c))}else{let m=d.data,c=Nt(m.files_modified,n,m.files_read),l=pe(m.created_at),O=l!==a;a=l;let E=t.has(m.id);if(c!==i&&(o.push(...Tt(c)),i=c),E){let b=Lt(m,s);o.push(...St(m,l,O,b,s))}else o.push(ft(m,l,O,s))}return o.push(""),o}function Ts(r,e,t,s,n,o){return o?gs(r,e,t,s,n):ps(r,e,t,s)}function Mt(r,e,t,s,n){let o=[],i=ls(r);for(let[a,d]of i)o.push(...Ts(a,d,e,t,s,n));return o}function Dt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function vt(r,e){let t=[];return e?(t.push(...H("Investigated",r.investigated,_.blue)),t.push(...H("Learned",r.learned,_.yellow)),t.push(...H("Completed",r.completed,_.green)),t.push(...H("Next Steps",r.next_steps,_.magenta))):(t.push(...$("Investigated",r.investigated)),t.push(...$("Learned",r.learned)),t.push(...$("Completed",r.completed)),t.push(...$("Next Steps",r.next_steps))),t}function yt(r,e){return e?Rt(r):at(r)}function Ut(r,e,t){return!K(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Ot(r.totalDiscoveryTokens,r.totalReadTokens):dt(r.totalDiscoveryTokens,r.totalReadTokens)}var fs=xt.default.join((0,wt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Ss(){try{return new j}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,kt.unlinkSync)(fs)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function bs(r,e){return e?ht(r):_t(r)}function Rs(r,e,t,s,n,o,i){let a=[],d=ce(e);a.push(...At(r,d,s,i));let m=t.slice(0,s.sessionCount),c=qe(m,t),l=Je(e,c),O=Qe(e,s.fullObservationCount);a.push(...Mt(l,O,s,n,i));let E=t[0],b=e[0];Dt(s,E,b)&&a.push(...vt(E,i));let h=Ke(e,s,o,n);return a.push(...yt(h,i)),a.push(...Ut(d,s,i)),a.join(`
`).trimEnd()}var Os=new Set(["bugfix","discovery","decision","refactor"]);function hs(r,e,t){let s=ce(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let m=Os.has(d.type)?d.type:"other";n[m]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function ge(r,e=!1){let t=He(),s=r?.cwd??process.cwd(),n=Fe(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Ss();if(!a)return{text:"",stats:null};try{let d=o.length>1?Ve(a,o,t):Be(a,i,t),m=o.length>1?Ye(a,o,t):We(a,i,t);return d.length===0&&m.length===0?{text:bs(i,e),stats:null}:{text:Rs(i,d,m,t,s,r?.session_id,e),stats:hs(d,m,!!r?.full)}}finally{a.close()}}async function Pt(r,e=!1){return(await ge(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
